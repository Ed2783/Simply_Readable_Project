...
export class dt_readableWorkflow extends Construct {
	...
	constructor(scope: Construct, id: string, props: props) {
		...
		this.modelChoiceCondition = sfn.Condition.stringEquals('$.jobDetails.modelId', 'amazon.titan-image-generator-v1');
		
		const invokeModelState = new tasks.LambdaInvoke(this, 'InvokeModel_AmazonTitanImage', {
