...
export class dt_readableWorkflow extends Construct {
	...
	constructor(scope: Construct, id: string, props: props) {
		...
		this.modelChoiceCondition = sfn.Condition.stringEquals('$.jobDetails.modelId', 'anthropic.claude-v2');
		
		const invokeModelState = new tasks.LambdaInvoke(this, 'InvokeModel_AnthropicClaude', {
