	...
	constructor(scope: Construct, id: string, props?: cdk.StackProps) {
		...
		const synth = new cdkpipelines.ShellStep("Synth", {
			...
			commands: [
				...
				"ls -la",
				"echo 'Document translation main contents:'",
				"ls -la document-translation-main",
				"echo 'Config directory contents:'",
				"ls -la document-translation-main/config",
				"echo 'Config file contents:'",
				"cat document-translation-main/config/config.json",
				"echo 'Creating infrastructure directory:'",
				"mkdir -p document-translation-main/infrastructure",
				"echo 'Copying config files:'",
				"cp document-translation-main/config/config.json document-translation-main/infrastructure/",
				"echo 'Verifying copied config files:'",
				"ls -la document-translation-main/infrastructure/config.json",
				"cat document-translation-main/infrastructure/config.json",
				"echo 'Changing to infrastructure directory:'",
				"cd document-translation-main/infrastructure",
				"npm ci",
				"npm run cdk synth",
			],
		});
