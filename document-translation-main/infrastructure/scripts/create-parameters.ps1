...
# Common parameters
Write-Host "Creating common parameters..."
...
# Pipeline parameters
Write-Host "Creating pipeline parameters..."
...
# App parameters
Write-Host "Creating app parameters..."
...
Write-Host "All parameters have been created successfully!"